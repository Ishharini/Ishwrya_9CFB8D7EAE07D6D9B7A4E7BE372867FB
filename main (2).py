write a function called linear_ search_ product that takes the list of products and a target product write a function called linear_ search_ product that takes the list of products and a target product 
